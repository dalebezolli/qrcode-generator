...
function drawSVG(matrix) {
	...
	const displaySize = (matrix.size + (EMPTY_SPACE * 2)) * PIXELS_PER_MODULE;

	let svg = `<svg id="svg" width="200px" height="200px" viewBox="0 0 ${displaySize} ${displaySize}" shape-rendering="crispEdges">`;
